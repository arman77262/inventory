        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">All Unites</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{route('supplier.add')}}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float: right">Add Unit</a> <br>

                    <h4 class="card-title">Unites All Data </h4>
